...
```json
{
  ...
  "amr": ["password", "pwd"],
  "azp": "259254409320529922",
  "client_id": "259254409320529922",
...
-H 'Accept: application/json' \
-u '259254409320529922:eNdXJzB5RK5CXSpa4HqEfbdDqlM7drpskEHq1RBYMby0tM1MaCidyWsWlp5mglbN' \
...
curl -L -X POST 'http://localhost:9000/oauth/v2/introspect' \
  -H 'Content-Type: application/x-www-form-urlencoded' \
  -u '259284000017809410:ES1i1JWgGiHNW6bBljyynZyvQIlotEpVwzbgrTIYZzndOo2KxDkwap1WvdSdBjtk' \
...
-H 'Content-Type: application/x-www-form-urlencoded' \
-H 'Accept: application/json' \
-d 'client_id=259254409320529922' \
...
```json
{
  "iss": "259297773508165634",
  "sub": "259297773508165634",
  "aud": [
    "http://localhost:9000"
  ],
  "iat": 1711102657,
...
```json
{
  ...
  "applicationId": "259297773508165634",
}
```
