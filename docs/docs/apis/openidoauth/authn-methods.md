...
Given the client_id `78366401571920522` and client_secret `veryweaksecret!`, this would result in the following `Authorization` header:
...
| clientId | `78366401571920522`                                                 | The client_id of the application, this is the same as the subject from tokens  |
...
| iss   | `"78366401571920522"`      | String which represents the requesting party (owner of the key), normally the `clientID` from the json key file |
| sub   | `"78366401571920522"` | The subject ID of the application, normally the `clientID` from the json key file                               |

```JSON
{
	"iss": "78366401571920522",
	"sub": "78366401571920522",
